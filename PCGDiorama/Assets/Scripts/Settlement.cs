...
public class Settlement : MonoBehaviour {
	...
	//
	// 		if (x > z) {
	// 			Vector3 start = ((a.GetRight().x < b.GetLeft().x) ? a.GetRight() : a.GetLeft()) + transform.position;
	// 			Vector3 end = ((a.GetRight().x < b.GetLeft().x) ? b.GetLeft() : b.GetRight()) + transform.position;
	// 			Vector3 point1 = start + new Vector3((end.x - start.x) / 2, 0.0f, 0.0f);
	// 			Vector3 point2 = end - new Vector3((end.x - start.x) / 2, 0.0f, 0.0f);
	//
	...
	//
	// 		} else {
	// 			Vector3 start = ((a.GetTop().z < b.GetBottom().z) ? a.GetTop() : a.GetBottom()) + transform.position;
	// 			Vector3 end = ((a.GetTop().z < b.GetBottom().z) ? b.GetBottom() : b.GetTop()) + transform.position;
	// 			Vector3 point1 = start + new Vector3(0.0f, 0.0f, (end.z - start.z) / 2);
	// 			Vector3 point2 = end - new Vector3(0.0f, 0.0f, (end.z - start.z) / 2);
	//
	// 			Vector3 lastPos = start;
	//
	// 			float resolution = 0.02f;
